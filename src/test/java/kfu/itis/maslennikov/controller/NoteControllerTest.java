...
class NoteControllerTest {
    ...
    void ownNotesShouldReturnNotesView() throws Exception {
        given(noteService.findOwnNotes("ivan")).willReturn(List.of(new Note()));
    ...
    void publicNotesShouldReturnPublicNotesViewWithQuery() throws Exception {
        given(noteService.findPublicNotes("spring")).willReturn(List.of(new Note()));

        mockMvc.perform(get("/notes/public").param("query", "spring"))
                .andExpect(status().isOk())
